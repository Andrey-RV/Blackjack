...
## Requirements
To run the program, you'll need Python 3.9 to avoid errors about Type Hints from PEP 585. Some annotations from the typing module that are not yet part of Python's standard library are also used. To play the game, download or clone the repository, navigate to the project directory, and run:
